...
DESC = """
    Agent "InvertedDoublePendulum" from myjoco environment. For details, see
...
class BmAgentPendInvDouble(Agent):
    def __init__(self, d=None, n=3, name='AgentPendInvDouble', desc=DESC,
...
if __name__ == '__main__':
    ...
    bm = BmAgentPendInvDouble(steps=250).prep()
    print(bm.info())
    ...
    bm = BmAgentPendInvDouble(steps=250, policy='direct').prep()
    ...
    bm = BmAgentPendInvDouble(steps=250, policy='toeplitz').prep()
