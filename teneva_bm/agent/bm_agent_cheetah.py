...
DESC = """
    Agent "Half Cheetah" from myjoco environment. For details, see
...
class BmAgentCheetah(Agent):
    def __init__(self, d=None, n=3, name='AgentCheetah', desc=DESC,
...
if __name__ == '__main__':
    ...
    bm = BmAgentCheetah(steps=250).prep()
    print(bm.info())
    ...
    bm = BmAgentCheetah(steps=250, policy='direct').prep()
    ...
    bm = BmAgentCheetah(steps=250, policy='toeplitz').prep()
