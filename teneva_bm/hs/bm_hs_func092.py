...
class BmHsFunc092(Bm):
    def __init__(self, d=6, n=64, seed=42, name=None):
        super().__init__(d, n, seed, name)
        self.set_desc("""
            The function 092 from the Hock & Schittkowski collection.
            ...
            t - intermediates
                ...
                emx[4] = exp(-mu ** 2 * x[4] ** 2)
                emx[5] = exp(-mu ** 2 * x[5] ** 2)
                r = emx[0] * emx[1] * emx[2] * emx[3] * emx[4] * emx[5] - \
                    2 * emx[1] * emx[2] * emx[3] * emx[4] * emx[5] + \
                    2 * emx[2] * emx[3] * emx[4] * emx[5] - \
                    2 * emx[3] * emx[4] * emx[5] + \ 
                    2 * emx[4] * emx[5] - \
                    2 * emx[5] + \
                    1
        ...
        self.set_grid([-10, -10, -10, -10, -10, -10], [+10, +10, +10, +10, +10, +10])
    ...
    def constr_batch(self, X):
        ...
        emx_4 = np.exp(-mu_2[None, :] * X[:, 4][:, None] ** 2)
        r = emx_0 * emx_1 * emx_2 * emx_3 * emx_4 - \
            2 * emx_1 * emx_2 * emx_3 * emx_4 + \
            2 * emx_2 * emx_3 * emx_4 - \
            2 * emx_3 * emx_4 + \
            2 * emx_4 - \
            1
