...
class BmHsFunc089(Bm):
    def __init__(self, d=3, n=64, seed=42, name=None):
        super().__init__(d, n, seed, name)
        self.set_desc("""
            The function 089 from the Hock & Schittkowski collection.
            ...
            t - intermediates
                ...
                r = emx[0] * emx[1] * emx[2] - 2 * emx[1] * emx[2] + 2 * emx[2] - 1
                aux1 = A ** 2 * r ** 2
    ...
    def constr_batch(self, X):
        ...
        r = emx_0 * emx_1 * emx_2 - 2 * emx_1 * emx_2 + 2 * emx_2 - 1
        aux1 = A ** 2 * r ** 2
        aux2 = snmuxcsmu / (2 * mu) + 1 / 2
        aux3 = -1 * A * r / mu ** 2
        aux4 = (-2) * snmu / mu + 2 * csmu
