...
- `func_fix` - a collection of analytic functions of a real multidimensional argument having the fixed dimension. The collection includes the following benchmarks: `BmFuncFixBiggs` (`d = 5`), `BmFuncFixColville` (`d = 4`), `BmFuncFixPiston` (`d=7`).
